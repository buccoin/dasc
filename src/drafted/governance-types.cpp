...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DasCoinNetwork") type = DasCoinNetwork;
    if(strType == "DasCoinNetworkVariable") type = DasCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DasCoinNetwork) s = "DasCoinNetwork";
    if(type == DasCoinNetworkVariable) s = "DasCoinNetworkVariable";
