...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("DasCoin Core DasCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  DasCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded DasCoin transaction") + "\n" +
              "  DasCoin-tx [options] -create [commands]   " + _("Create hex-encoded DasCoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded DasCoin transaction
