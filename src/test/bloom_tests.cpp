...
BOOST_AUTO_TEST_CASE(merkle_block_2)
{
    ...
    // Match an output from the second transaction (the pubkey for address 1DZTzaBHUDASC7T3QvUKBz4qXMRpkg8jsfB5)
...
BOOST_AUTO_TEST_CASE(rolling_bloom)
{
    ...
    // Run test_DasCoin with --log_level=message to see BOOST_TEST_MESSAGEs:
