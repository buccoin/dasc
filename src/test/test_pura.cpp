...
#define BOOST_TEST_MODULE DasCoin Test Suite

#include "test_DasCoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_DasCoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
