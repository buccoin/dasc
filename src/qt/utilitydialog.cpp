    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("DasCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About DasCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  DasCoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the DasCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DASC, 0.1 DASC, 1 DASC and 10 DASC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://DasCoinpay.atlassian.net/wiki/display/DOC/PrivatePay\">https://DasCoinpay.atlassian.net/wiki/display/DOC/PrivatePay</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("DasCoin Core is shutting down...") + "<br /><br />" +
