    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("DasCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DasCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and DasCoin: URIs)"));
    ...
    minerAction = new QAction(QIcon(":/icons/" + theme + "/miner"), tr("Miner"), this);
    minerAction->setStatusTip(tr("Miner"));
    minerAction->setToolTip(minerAction->statusTip());
    minerAction->setCheckable(true);
    minerAction->setVisible(false);
    tabGroup->addAction(minerAction);

    unminerAction = new QAction(QIcon(":/icons/" + theme + "/unminer"), tr("Unminer"), this);
    ...
    explorerAction = new QAction(QIcon(":/icons/" + theme + "/explorer"), tr("Explorer"), this);
    explorerAction->setStatusTip(tr("Explorer"));
    ...
    connect(unminerAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    ...
    connect(explorerAction, SIGNAL(triggered()), this, SLOT(gotoExplorer()));
#endif // ENABLE_WALLET
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About DasCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about DasCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DasCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DasCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DasCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a DasCoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DasCoin Core help message to get a list with possible DasCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("DasCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoMiner()
{
    ...
    GenerateBitcoins(true, 2, params,connman);
}
...
void BitcoinGUI::gotoUnminer()
{
    ...
    GenerateBitcoins(false, 2, params,connman);
}

void BitcoinGUI::gotoExplorer()
{
    QUrl AuthorUrl("http://47.75.73.236/");
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DasCoin network", "", count));
}
...
{
    QString strTitle = tr("DasCoin Core"); // default title
