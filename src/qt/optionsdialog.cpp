    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DASC-light"), QVariant("light"));
    ui->theme->addItem(QString("DASC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DASC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DASC-traditional"), QVariant("trad"));
